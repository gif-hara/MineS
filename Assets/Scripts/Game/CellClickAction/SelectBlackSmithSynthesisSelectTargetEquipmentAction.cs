...
namespace MineS
{
	...
	/// .
	/// </summary>
	public class SelectBlackSmithSynthesisSelectTargetEquipmentAction : CellClickActionBase
	{
		private Item item;

		public SelectBlackSmithSynthesisSelectTargetEquipmentAction(Item item)
		{
			this.item = item;
		}
