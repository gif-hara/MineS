...
namespace Ulfred
{
    public class UlfredEditorWindow : EditorWindow
    {
        ...
        private void DrawScrollbar()
        {
            ...
            var scrollY = findAssetTableRect.height * ((float)(this.listIndex) / (this.findAssetAccessCounts.Count));
        ...
        private Rect FindAssetTableRect
        {
            get
            {
                ...
                var heightCount = this.findAssetAccessCounts.Count;
        ...
        private int ListIndexMax
        {
            get
            {
                ...
                var result = this.IsCommandMode
                    ? (this.findCommandAccessCounts.Count) - Data.Instance.searchCount
                    : (this.findAssetAccessCounts.Count) - Data.Instance.searchCount;
        ...
        private int SelectIndexMax
        {
            get
            {
                var result = Data.Instance.searchCount - 1;
                var max = this.IsCommandMode
